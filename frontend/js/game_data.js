...
const difficulties = {
    easy: `Hej! Jag är på gymnasiemässan idag. Jag skriver en text som ska vara rolig och intressant. Malmö är en fin stad med många skolor. Jag försöker skriva snabbt och tänka på bra idéer. Jag hoppas ha kul och kanske vinna ett pris.`,
...
export async function add_score(score) {
    ...
    localStorage.setItem("score", score * score_multipliers[difficulty]);
